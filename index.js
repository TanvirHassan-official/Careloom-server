...
async function run() {
  ...
  // GET /doctors/top-rated — top 3 doctors by rating (home page)
  // ⚠️ Must be defined BEFORE /doctors/:id to avoid "top-rated" being treated as an id
  ...
  // GET /doctors/specialties — unique specialty list (for filter dropdown & category grid)
  // ⚠️ Must be defined BEFORE /doctors/:id
